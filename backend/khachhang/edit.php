            ...
            <div class="col-md-9">
                ...
                <form name="frmThemMoi" id="frmThemMoi" action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" name="sp_ten" id="sp_ten" class="form-control" value="<?= $dataSanPhamCu['sp_ten'] ?>"/>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Giá mới</label>
                                <input type="text" name="sp_gia" id="sp_gia" class="form-control" value="<?= $dataSanPhamCu['sp_gia'] ?>"/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Giá cũ</label>
                                <input type="text" name="sp_giacu" class="form-control" value="<?= $dataSanPhamCu['sp_giacu'] ?>"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Mô tả ngắn</label>
                        <textarea id="sp_mota_ngan" name="sp_mota_ngan" class="form-control"><?= $dataSanPhamCu['sp_mota_ngan'] ?></textarea>
                    </div>

                    <div class="form-group">
                        <label>Số lượng</label>
                        <input type="number" name="sp_soluong" class="form-control" value="<?= $dataSanPhamCu['sp_soluong'] ?>"/>
                    </div>
                    <div class="form-group">
